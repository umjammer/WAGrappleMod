...
public class GrappleItem extends Item{
	...
	public int getLengthEnchantmentMultiplier(NBTList NBTList) {
		int result = 1;
		NbtCompound ctag = (NbtCompound)NBTList.stream().filter(tag -> {
	...
	public double getBoostEnchantmentMultiplier(NBTList NBTList) {
		double result = 1;
		NbtCompound ctag = (NbtCompound)NBTList.stream().filter(tag -> {
